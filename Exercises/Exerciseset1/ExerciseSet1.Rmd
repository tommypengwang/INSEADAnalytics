...
<br>
*Question 1*
in dataSet1.R, mytickers = c("SPY", "AAPL")
<br>
*Qestion 2*
#sum(StockReturns[,"AAPL"])'
5.972571
#mean(StockReturns[,"AAPL"])
0.001479458
#sd((StockReturns[,"AAPL"]))
[1] 0.02387808
<br>
*Question 3*
mytickers = c("SPY", "AAPL", "YAHOO")
#mean((StockReturns[,"YHOO"]))
[1] 0.0007201133
#sum((StockReturns[,"YHOO"]))
[1] 2.907097
#sd((StockReturns[,"YHOO"]))
[1] 0.0301738
<br>
...
names(portfolio) <- rownames(transposedData)
pnl_plot(portfolio)
<br>
<br>
...
<br>
*Question 1*
No need to do anything because the start date is already set to 
2001-01-01 (startDate = "2001-01-01" is from dataSet1.R)
<br>
*Question 2*
Add more companies in to the line mytickers = c("SPY", "AAPL") and run the report. e.g. if we want to include Yahoo in the report, we just need to change the line to 'mytickers = c("SYP", "AAPL", "YHOO")'
<br>
<br>
...
<br>
*Question 1*
I get output 20 when I run this command
sum(myData != StockReturns[1:20,])
[1] 20

<br>
*Question 2*
I got error message 'non-numeric argument to binary operator' when I run it, but i was expecting some different error like not enough rows because the data only has 20 rows
<br>
<br>
